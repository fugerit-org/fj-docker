...
if [[ "${VERSION_TAG}" == "" ]]; then
	...
	REPO2=${DOCKER_ACCOUNT}/redhat-ubi8-openjdk
	echo "VERSION_TAG : ${VERSION_TAG}"
	TAG1="${REPO1}:redhat-ubi8-openjdk-11-runtime-1.17-5-fontconfig.${VERSION_TAG}"
	TAG2="${REPO2}:11-runtime-1.17-5-fontconfig.${VERSION_TAG}"
